...
nGIST is the extension of the [gist pipeline](https://abittner.gitlab.io/thegistpipeline/), originally written by Adrian Bittner. The current lead developers are Amelia Fraser-McKelvie and Jesse van de Sande
